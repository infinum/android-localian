...
/**
 * Converts the language Localian saved into [LocaleManager], once, and then forgets it.
...
object LocalianMigration {
    ...
    fun restoreSelectedLanguage(activity: Activity) {
        ...
        val deviceLanguage = activity.resources.configuration.locales[0].language
